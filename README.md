...
*TT* or "taxi-tools" is a suite of interactive prototypes exploring various HMI interactions using a Reactive Native mobile application and a Raspberry Pi running a Flask server. The purpose is to experiment with creating wireless solutions to enhance the passenger experience.
